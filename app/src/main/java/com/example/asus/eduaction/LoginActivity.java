...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mEmailSignInButton.setOnClickListener(new OnClickListener() {
            public void onClick(View view) {
                findbyname(mEmailView.getText().toString());
            }
        });
        register.setOnClickListener(new OnClickListener() {
            public void onClick(View view) {
                Intent intentSimple = new Intent();
                intentSimple.setClass(LoginActivity.this,registerActivity.class);
    ...
    private void findbyname(String name)  {
        ...
        final Request request = new Request.Builder()
                .url("http://39.97.176.139:8080/find_by_name")
                .post(builder.build())
                .build();
      /*  Response response = mOkHttpClient.newCall(request).execute();*/
        ...
        call.enqueue(new Callback() {
            ...
            public void onResponse(Response response) throws IOException {
                ...
                if(studentEntities.get(0).getAge().equals(mPasswordView.getText().toString())) {
                    runOnUiThread(new Runnable() {//这是Activity的方法，会在主线程执行任务
                        @Override
                        public void run() {
                            Toast.makeText(LoginActivity.this, "登录成功", Toast.LENGTH_SHORT).show();
                            Intent intentSimple = new Intent();
                            intentSimple.setClass(LoginActivity.this, MainActivity.class);
                            startActivity(intentSimple);
                            finish();
                        }
                    });
